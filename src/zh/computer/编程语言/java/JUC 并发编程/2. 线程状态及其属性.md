...
- 实现 `callable` 接口，提交给 ExecutorService 返回的是异步执行的结果，另外，通常也可以利用 `FutureTask(Callable callable)` 将 callable 进行包装然后 FeatureTask 提交给 ExecutorsService。如下图所示：
  ...
  ![](./image/3e4a8db29f2b2d5262c8d5328faf45ad.png)
...
![](./image/bd5dcfd54dd080a2f4992531c580b5bb.png)
...
![](./image/77bdb0322c093e570d5838bb64779e24.png)
...
![](./image/ab5e9e206cca13e20f2e5df721e0c5d4.png)
